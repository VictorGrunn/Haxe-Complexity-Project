 ...
 * @author Victor Grunn
 */
class TitleOptionsButton extends TitlePiece
{
	...
	override public function init(_name:String):Void 
	{
		...
		optionsText.text = "This is just a placeholder skeleton for when I actually eventually add the options. Just click to get it offscreen for now.";
